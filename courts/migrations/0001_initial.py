# Generated by Django 5.0.6 on 2024-06-01 23:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created", models.DateTimeField(auto_now_add=True)),
                ("tags", models.ManyToManyField(blank=True, to="courts.tag")),
            ],
        ),
        migrations.CreateModel(
            name="Trainer",
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, to="courts.profile"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="courts.user"
                    ),
                ),
            ],
        ),
